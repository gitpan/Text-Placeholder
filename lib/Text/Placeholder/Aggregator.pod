...
Text::Placeholder::Aggregator - groups groups
...
Provides the placeholder symbols of the registered groups. Rationale: there are cases where you want to set the subject only once.

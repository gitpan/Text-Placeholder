...
Text::Placeholder::Generic - a basket to be filled with placeholders
...
Text::Placeholder::Generic provides no placeholders by default. Any sense has to be added via add_placeholder (see below). Keep in mind that the placeholders have to be added before compilation.

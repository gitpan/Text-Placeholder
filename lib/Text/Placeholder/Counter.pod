...
Text::Placeholder::Counter - counts execution of placeholder substitution
...
Text::Placeholder::Counter provides the placeholder symbol 'counter'. Increments the counter each time 'execute' is called.

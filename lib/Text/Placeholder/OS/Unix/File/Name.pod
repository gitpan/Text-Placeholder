...
Text::Placeholder::OS::Unix::File::Name - access name parts of a file
...
Provides the placeholder symbols file_name_(full|path|only|extension). The file doesn't needs to exists.
